...
namespace NS_Composants
{
    ...
    {
        return "SELECT id_adresse, adresse livraison, id facturation " +
            "FROM TB_ADRESSE " +
            "WHERE(id_personne = " + this->id_adresse + ");";

    }

    String^ CL_Adresse::INSERT(void)
    {
        return "INSERT INTO TB_ADRESSE(adresse facturation, adresse livraison) " +
            "VALUES('" + this->ville + "', '" + this->cp + ");";
